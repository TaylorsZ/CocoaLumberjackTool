...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CocoaLumberjackTool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhangs1992@126.com/CocoaLumberjackTool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangs1992@126.com' => 'zhangs1992@126.com' }
  s.source           = { :git => 'https://github.com/zhangs1992@126.com/CocoaLumberjackTool.git', :tag => s.version.to_s }
